        ...
        EventChannel(flutterEngine.dartExecutor.binaryMessenger, EVENT_CHANNEL).setStreamHandler(
            object : EventChannel.StreamHandler {
                override fun onListen(arguments: Any?, events: EventChannel.EventSink?) {
                    android.util.Log.d("MainActivity", "onListen: Location EventChannel subscribed")
                    eventSink = events
                    LocationTrackerService.locationUpdateListener = { location: Location ->
                        runOnUiThread {
                            android.util.Log.d("MainActivity", "Forwarding location to Flutter: ${location.latitude}")
